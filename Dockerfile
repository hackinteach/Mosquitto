...
#RUN apt-get install wget build-essential libwrap0-dev libcurl4-openssl-dev libssl-dev python-distutils-extra libc-ares-dev uuid-dev libmysqlclient-dev unzip -y
RUN apt-get install wget build-essential libwrap0-dev libcurl4-openssl-dev libssl-dev python-distutils-extra uuid-dev libmysqlclient-dev unzip -y
